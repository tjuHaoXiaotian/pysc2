...
class StaticData(object):
  ...
  def __init__(self, data):
    ...
    # f = open("raw_data{}.txt".format(time.time()), "a") # 打开文件以便写入
    # np.set_printoptions(threshold=np.inf)  # 全部输出
    # f.write(str(data))
    # # print(data.units, file=f)
    # f.flush()
    # f.close()
  ...
  def print_static_datas(self,file):
      print("units: ",file=file)
      print(self._units,file=file)
      print("abilities: ",file=file)
      print(self._abilities,file=file)
      print("general abilities: ",file=file)
      print(self._general_abilities,file=file)
