...
mod_names: "Mods/VoidMulti.SC2Mod"
  ...
  def init_window(self):
    ...
    # Just flip so the base minimap is TL origin （将原点变换到 左上角 Top Left）
    ...
    self._world_to_fl_screen = transform.Chain(
        ...
        transform.Floor())
    # print(self._map_size.y)
    # print(self._feature_layer_screen_size)
    # print(self._camera_width_world_units)
