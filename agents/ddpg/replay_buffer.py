...
class ReplayBuffer(object):
  ...
  def sample_batch(self, batch_size):
    ...
    state_batch, action_batch, reward_batch, next_state_batch, terminated_batch, model_indexes  = [], [], [], [], [], []
    for idx in indices:
      ...
      if trans_1.terminated is not True:
        ...
        model_indexes.append(trans_2.model_idx)
      else:
        ...
        if idx != 0: # not the first one
          ...
          model_indexes.append(trans_1.model_idx)
        else:
